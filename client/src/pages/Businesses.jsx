...
const styles = {
    ...
    form: { display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 400, marginBottom: 24, padding: 16, background: '#f9f9f9', borderRadius: 8 },
    input: { padding: '8px 12px', fontSize: 15, border: '1px solid #ccc', borderRadius: 4 },
    grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: 20 },
    card: { border: '1px solid #ddd', borderRadius: 8, overflow: 'hidden', cursor: 'pointer', transition: 'box-shadow .2s' },
    logo: { width: '100%', height: 120, objectFit: 'cover' },
    cardBody: { padding: 16 },
    name: { fontSize: 17, fontWeight: 600, marginBottom: 4 },
    bio: { color: '#555', fontSize: 14, marginBottom: 8 },
