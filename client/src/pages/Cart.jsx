...
const styles = {
    ...
    row: { display: 'flex', alignItems: 'center', gap: 12, padding: 12, border: '1px solid #eee', borderRadius: 8 },
    ...
    qtyBtn: { width: 28, height: 28, border: '1px solid #ccc', background: '#fff', cursor: 'pointer', borderRadius: 4, fontSize: 16 },
    qty: { width: 24, textAlign: 'center', fontSize: 15 },
    lineTotal: { fontWeight: 600, minWidth: 60, textAlign: 'right' },
    removeBtn: { background: 'none', border: 'none', cursor: 'pointer', color: '#999', fontSize: 16 },
    summary: { padding: 16, background: '#f9f9f9', borderRadius: 8 },
    input: { padding: '8px 12px', border: '1px solid #ccc', borderRadius: 4, fontSize: 14, marginBottom: 12, width: '100%' },
