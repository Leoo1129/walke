...
const styles = {
    ...
    search: { padding: '8px 12px', fontSize: 15, border: '1px solid var(--border-input)', borderRadius: 4, width: 280 },
    ...
    seller: { fontSize: 13, color: 'var(--text-muted)', marginBottom: 8 },
    sellerLink: { cursor: 'pointer', color: '#0066cc', textDecoration: 'underline' },
    tags: { display: 'flex', gap: 4, flexWrap: 'wrap', marginBottom: 10 },
    tag: { fontSize: 11, background: 'var(--tag-bg)', padding: '2px 8px', borderRadius: 12 },
